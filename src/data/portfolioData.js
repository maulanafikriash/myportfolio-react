const portfolio = [
...

  {
    ...
    description: {
      intro:
        "KEMAS.id was developed as a capstone project for the SIB Kampus Merdeka x Dicoding Cycle 5 program and was selected as one of the top capstones. Worked in a team of 4 - 5 members to design and implement the platform. My roles in this project :",
      points: [
  ...
  },
  {
    ...
    tech: "Webpack, JavaScript, HTML, CSS (Vanilla) + PWA, API",
  },
  {
    id: 7,
    title: "Diskusi APP",
